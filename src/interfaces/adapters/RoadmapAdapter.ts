...
export const roadmapTableAdapter = (roadmaps: Roadmap[]): TableDataType<Roadmap>[] =>{
    return roadmaps.map((roadmap) => ({
        ...roadmap,
        key: `${roadmap.car}-:-${roadmap.roadmap_date}`,
        car_code: roadmap.car?.car_code,
        departure_time: roadmap.departure_time ? dayjs(roadmap.departure_time).format("hh:mm A") : null,
    }));
};
...
export const roadmapFormAdapter = (
    ...
    departure_time: roadmap.departure_time ? dayjs(roadmap.departure_time).format("HH:mm")
    : "",
...
export const roadmapTypesAdapter = (
   ...
   roadmap_date: roadmap.roadmap_date ? new Date(roadmap.roadmap_date) : new Date(),
