...
export const discrepancyTableAdapter = (
  discrepancies: Discrepancy[]
): TableDataType<Discrepancy>[] => {
  return discrepancies.map((discrepancy) => ({
    ...
    consumed_fuel: discrepancy.planned_fuel || "",
...
export const discrepancyTypesAdapter = (
  ...
  month_code: discrepancy.month_code
    ? new Date(discrepancy.month_code)
    : new Date(),
